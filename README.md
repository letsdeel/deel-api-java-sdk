...
Deel REST API
- API version: 1.25.0
  - Build date: 2024-12-18T16:04:44.564028033Z[GMT]
...
```groovy
  ...
  dependencies {
     implementation "com.deel:deel-api-java-sdk:test-1.0.4"
  }
```
...
* `target/deel-api-java-sdk-test-1.0.4.jar`
* `target/lib/*.jar`
