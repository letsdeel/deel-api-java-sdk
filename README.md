...
Deel REST API
- API version: 1.25.0
  - Build date: 2024-12-24T17:16:06.545846627Z[GMT]
...
```groovy
  ...
  dependencies {
     implementation "com.deel:deel-api-java-sdk:alpha-0.0.7"
  }
```
...
* `target/deel-api-java-sdk-alpha-0.0.7.jar`
* `target/lib/*.jar`
