...
Deel REST API
- API version: 1.25.0
  - Build date: 2024-12-18T16:17:35.281321822Z[GMT]
...
```groovy
  ...
  dependencies {
     implementation "com.deel:deel-api-java-sdk:test-1.0.5"
  }
```
...
* `target/deel-api-java-sdk-test-1.0.5.jar`
* `target/lib/*.jar`
