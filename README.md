...
Deel REST API
- API version: 1.25.0
  - Build date: 2024-12-24T17:29:26.705508686Z[GMT]
...
```groovy
  ...
  dependencies {
     implementation "com.deel:deel-api-java-sdk:alpha-0.0.8"
  }
```
...
* `target/deel-api-java-sdk-alpha-0.0.8.jar`
* `target/lib/*.jar`
