...
public class WorkerRelationsApi {
    ...
    private okhttp3.Call upsertParentWorkerRelationsExternalIdCall(UUID profileId, UpsertParentWorkerRelationsExternalIdRequest upsertParentWorkerRelationsExternalIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = upsertParentWorkerRelationsExternalIdRequest;

        // create path and map variables
        String localVarPath = "/hris/worker_relations/profile/external/{profileId}/parent"
            .replace("{" + "profileId" + "}", localVarApiClient.escapeString(profileId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertParentWorkerRelationsExternalIdValidateBeforeCall(UUID profileId, UpsertParentWorkerRelationsExternalIdRequest upsertParentWorkerRelationsExternalIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'profileId' is set
        if (profileId == null) {
            throw new ApiException("Missing the required parameter 'profileId' when calling upsertParentWorkerRelationsExternalId(Async)");
        }

        // verify the required parameter 'upsertParentWorkerRelationsExternalIdRequest' is set
        if (upsertParentWorkerRelationsExternalIdRequest == null) {
            throw new ApiException("Missing the required parameter 'upsertParentWorkerRelationsExternalIdRequest' when calling upsertParentWorkerRelationsExternalId(Async)");
        }

        return upsertParentWorkerRelationsExternalIdCall(profileId, upsertParentWorkerRelationsExternalIdRequest, _callback);

    }


    private ApiResponse<Void> upsertParentWorkerRelationsExternalIdWithHttpInfo(UUID profileId, UpsertParentWorkerRelationsExternalIdRequest upsertParentWorkerRelationsExternalIdRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertParentWorkerRelationsExternalIdValidateBeforeCall(profileId, upsertParentWorkerRelationsExternalIdRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call upsertParentWorkerRelationsExternalIdAsync(UUID profileId, UpsertParentWorkerRelationsExternalIdRequest upsertParentWorkerRelationsExternalIdRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertParentWorkerRelationsExternalIdValidateBeforeCall(profileId, upsertParentWorkerRelationsExternalIdRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class APIupsertParentWorkerRelationsExternalIdRequest {
        private final UUID profileId;
        private final UpsertParentWorkerRelationsExternalIdRequest upsertParentWorkerRelationsExternalIdRequest;

        private APIupsertParentWorkerRelationsExternalIdRequest(UUID profileId, UpsertParentWorkerRelationsExternalIdRequest upsertParentWorkerRelationsExternalIdRequest) {
            this.profileId = profileId;
            this.upsertParentWorkerRelationsExternalIdRequest = upsertParentWorkerRelationsExternalIdRequest;
        }

        /**
         * Build call for upsertParentWorkerRelationsExternalId
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute upsertParentWorkerRelationsExternalId request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public void execute() throws ApiException {
            upsertParentWorkerRelationsExternalIdWithHttpInfo(profileId, upsertParentWorkerRelationsExternalIdRequest);
        }

        /**
         * Execute upsertParentWorkerRelationsExternalId request with HTTP info returned
         * @return ApiResponse&lt;Void&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return upsertParentWorkerRelationsExternalIdWithHttpInfo(profileId, upsertParentWorkerRelationsExternalIdRequest);
        }

        /**
         * Execute upsertParentWorkerRelationsExternalId request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return upsertParentWorkerRelationsExternalIdAsync(profileId, upsertParentWorkerRelationsExternalIdRequest, _callback);
        }
    }
     ...
     */
    public APIupsertParentWorkerRelationsExternalIdRequest upsertParentWorkerRelationsExternalId(UUID profileId, UpsertParentWorkerRelationsExternalIdRequest upsertParentWorkerRelationsExternalIdRequest) {
        return new APIupsertParentWorkerRelationsExternalIdRequest(profileId, upsertParentWorkerRelationsExternalIdRequest);
    }
}
