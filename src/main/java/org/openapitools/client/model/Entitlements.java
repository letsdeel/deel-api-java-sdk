...
public class Entitlements {
  ...
  @javax.annotation.Nullable
  private List<EntitlementsRolloversInner> rollovers;
  ...
  @javax.annotation.Nullable
  private List<EntitlementsFutureEventsInner> futureEvents = new ArrayList<>();

  public Entitlements() {
  }

  public Entitlements id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Entitlements trackingPeriod(@javax.annotation.Nullable String trackingPeriod) {
  ...
  public void setTrackingPeriod(@javax.annotation.Nullable String trackingPeriod) {
    this.trackingPeriod = trackingPeriod;
  }


  public Entitlements trackingPeriodEndDate(@javax.annotation.Nullable String trackingPeriodEndDate) {
    this.trackingPeriodEndDate = trackingPeriodEndDate;
    return this;
  }

  /**
   * Get trackingPeriodEndDate
  ...
  public void setTrackingPeriodEndDate(@javax.annotation.Nullable String trackingPeriodEndDate) {
    this.trackingPeriodEndDate = trackingPeriodEndDate;
  }


  public Entitlements accrued(@javax.annotation.Nullable String accrued) {
  ...
  public Entitlements balanceAdjusted(@javax.annotation.Nullable String balanceAdjusted) {
  ...
  public Entitlements allowance(@javax.annotation.Nullable String allowance) {
  ...
  public Entitlements available(@javax.annotation.Nullable String available) {
  ...
  public Entitlements approved(@javax.annotation.Nullable String approved) {
  ...
  public Entitlements expired(@javax.annotation.Nullable String expired) {
  ...
  public Entitlements requested(@javax.annotation.Nullable String requested) {
  ...
  public Entitlements rollovers(@javax.annotation.Nullable List<EntitlementsRolloversInner> rollovers) {
    this.rollovers = rollovers;
    return this;
  }

  public Entitlements addRolloversItem(EntitlementsRolloversInner rolloversItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<EntitlementsRolloversInner> getRollovers() {
    return rollovers;
  }

  public void setRollovers(@javax.annotation.Nullable List<EntitlementsRolloversInner> rollovers) {
    this.rollovers = rollovers;
  }


  public Entitlements used(@javax.annotation.Nullable String used) {
    this.used = used;
    return this;
  }
  ...
  public Entitlements totalEntitlements(@javax.annotation.Nullable String totalEntitlements) {
    this.totalEntitlements = totalEntitlements;
    return this;
  }

  /**
   * Get totalEntitlements
  ...
  public void setTotalEntitlements(@javax.annotation.Nullable String totalEntitlements) {
    this.totalEntitlements = totalEntitlements;
  }


  public Entitlements upcomingAccruals(@javax.annotation.Nullable String upcomingAccruals) {
    this.upcomingAccruals = upcomingAccruals;
    return this;
  }

  /**
   * Get upcomingAccruals
  ...
  public Entitlements accrualAmount(@javax.annotation.Nullable String accrualAmount) {
  ...
  public Entitlements accrualUnit(@javax.annotation.Nullable AccrualUnitEnum accrualUnit) {
  ...
  public Entitlements pastTrackingPeriods(@javax.annotation.Nullable List<String> pastTrackingPeriods) {
    this.pastTrackingPeriods = pastTrackingPeriods;
    return this;
  }

  public Entitlements addPastTrackingPeriodsItem(String pastTrackingPeriodsItem) {
  ...
  public Entitlements timeOffEventId(@javax.annotation.Nullable String timeOffEventId) {
  ...
  public Entitlements policy(@javax.annotation.Nullable EntitlementsPolicy policy) {
    this.policy = policy;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public EntitlementsPolicy getPolicy() {
    return policy;
  }

  public void setPolicy(@javax.annotation.Nullable EntitlementsPolicy policy) {
    this.policy = policy;
  }


  public Entitlements futureEvents(@javax.annotation.Nullable List<EntitlementsFutureEventsInner> futureEvents) {
    this.futureEvents = futureEvents;
    return this;
  }

  public Entitlements addFutureEventsItem(EntitlementsFutureEventsInner futureEventsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<EntitlementsFutureEventsInner> getFutureEvents() {
    return futureEvents;
  }

  public void setFutureEvents(@javax.annotation.Nullable List<EntitlementsFutureEventsInner> futureEvents) {
    this.futureEvents = futureEvents;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, entitlements.id) &&
        Objects.equals(this.trackingPeriod, entitlements.trackingPeriod) &&
        Objects.equals(this.trackingPeriodEndDate, entitlements.trackingPeriodEndDate) &&
        Objects.equals(this.accrued, entitlements.accrued) &&
        Objects.equals(this.balanceAdjusted, entitlements.balanceAdjusted) &&
        Objects.equals(this.allowance, entitlements.allowance) &&
        Objects.equals(this.available, entitlements.available) &&
        Objects.equals(this.approved, entitlements.approved) &&
        Objects.equals(this.expired, entitlements.expired) &&
        Objects.equals(this.requested, entitlements.requested) &&
        Objects.equals(this.rollovers, entitlements.rollovers) &&
        Objects.equals(this.used, entitlements.used) &&
        Objects.equals(this.totalEntitlements, entitlements.totalEntitlements) &&
        Objects.equals(this.upcomingAccruals, entitlements.upcomingAccruals) &&
        Objects.equals(this.accrualAmount, entitlements.accrualAmount) &&
        Objects.equals(this.accrualUnit, entitlements.accrualUnit) &&
        Objects.equals(this.pastTrackingPeriods, entitlements.pastTrackingPeriods) &&
        Objects.equals(this.timeOffEventId, entitlements.timeOffEventId) &&
        Objects.equals(this.policy, entitlements.policy) &&
        Objects.equals(this.futureEvents, entitlements.futureEvents);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, trackingPeriod, trackingPeriodEndDate, accrued, balanceAdjusted, allowance, available, approved, expired, requested, rollovers, used, totalEntitlements, upcomingAccruals, accrualAmount, accrualUnit, pastTrackingPeriods, timeOffEventId, policy, futureEvents);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Entitlements
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Entitlements.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Entitlements.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Entitlements` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("tracking_period") != null && !jsonObj.get("tracking_period").isJsonNull()) && !jsonObj.get("tracking_period").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("tracking_period_end_date") != null && !jsonObj.get("tracking_period_end_date").isJsonNull()) && !jsonObj.get("tracking_period_end_date").isJsonPrimitive()) {
      ...
      if (jsonObj.get("rollovers") != null && !jsonObj.get("rollovers").isJsonNull()) {
        ...
        if (jsonArrayrollovers != null) {
          ...
          for (int i = 0; i < jsonArrayrollovers.size(); i++) {
            EntitlementsRolloversInner.validateJsonElement(jsonArrayrollovers.get(i));
          };
        }
      }
      ...
      if ((jsonObj.get("total_entitlements") != null && !jsonObj.get("total_entitlements").isJsonNull()) && !jsonObj.get("total_entitlements").isJsonPrimitive()) {
      ...
      if (jsonObj.get("policy") != null && !jsonObj.get("policy").isJsonNull()) {
        EntitlementsPolicy.validateJsonElement(jsonObj.get("policy"));
      }
      if (jsonObj.get("future_events") != null && !jsonObj.get("future_events").isJsonNull()) {
        ...
        if (jsonArrayfutureEvents != null) {
          ...
          for (int i = 0; i < jsonArrayfutureEvents.size(); i++) {
            EntitlementsFutureEventsInner.validateJsonElement(jsonArrayfutureEvents.get(i));
          };
        }
      }
  }
