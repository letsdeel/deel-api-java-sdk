...
public class Entitlements {
  ...
  public Entitlements id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Entitlements trackingPeriod(String trackingPeriod) {
  ...
  public Entitlements trackingPeriodEndDate(String trackingPeriodEndDate) {
  ...
  public Entitlements accrued(String accrued) {
  ...
  public Entitlements balanceAdjusted(String balanceAdjusted) {
  ...
  public Entitlements allowance(String allowance) {
  ...
  public Entitlements available(String available) {
  ...
  public Entitlements approved(String approved) {
  ...
  public Entitlements expired(String expired) {
  ...
  public Entitlements requested(String requested) {
  ...
  public Entitlements rollovers(List<EntitlementsRolloversInner> rollovers) {
  ...
  public void setRollovers(List<EntitlementsRolloversInner> rollovers) {
    this.rollovers = rollovers;
  }


  public Entitlements used(String used) {
    this.used = used;
    return this;
  }
  ...
  public Entitlements totalEntitlements(String totalEntitlements) {
  ...
  public Entitlements upcomingAccruals(String upcomingAccruals) {
  ...
  public Entitlements accrualAmount(String accrualAmount) {
  ...
  public Entitlements accrualUnit(AccrualUnitEnum accrualUnit) {
  ...
  public Entitlements pastTrackingPeriods(List<String> pastTrackingPeriods) {
  ...
  public Entitlements timeOffEventId(String timeOffEventId) {
  ...
  public Entitlements policy(EntitlementsPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public void setPolicy(EntitlementsPolicy policy) {
    this.policy = policy;
  }


  public Entitlements futureEvents(List<EntitlementsFutureEventsInner> futureEvents) {
  ...
  public void setFutureEvents(List<EntitlementsFutureEventsInner> futureEvents) {
    this.futureEvents = futureEvents;
  }
