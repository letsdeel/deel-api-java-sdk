...
public class TimeOffRequestBodyCommonProperties {
  ...
  public TimeOffRequestBodyCommonProperties addAttachmentsItem(Attachment attachmentsItem) {
  ...
  public TimeOffRequestBodyCommonProperties addDatesItem(TimeOffDate datesItem) {
    if (this.dates == null) {
  ...
  public boolean equals(Object o) {
    ...
    TimeOffRequestBodyCommonProperties timeOffRequestBodyCommonProperties = (TimeOffRequestBodyCommonProperties) o;
    return Objects.equals(this.recipientProfileId, timeOffRequestBodyCommonProperties.recipientProfileId) &&
        Objects.equals(this.otherTypeDescription, timeOffRequestBodyCommonProperties.otherTypeDescription) &&
        Objects.equals(this.reason, timeOffRequestBodyCommonProperties.reason) &&
        Objects.equals(this.startDate, timeOffRequestBodyCommonProperties.startDate) &&
        Objects.equals(this.endDate, timeOffRequestBodyCommonProperties.endDate) &&
        Objects.equals(this.timeOffTypeId, timeOffRequestBodyCommonProperties.timeOffTypeId) &&
        Objects.equals(this.description, timeOffRequestBodyCommonProperties.description) &&
        Objects.equals(this.deductionAmount, timeOffRequestBodyCommonProperties.deductionAmount) &&
        Objects.equals(this.isPaid, timeOffRequestBodyCommonProperties.isPaid) &&
        Objects.equals(this.contractOid, timeOffRequestBodyCommonProperties.contractOid) &&
        Objects.equals(this.attachments, timeOffRequestBodyCommonProperties.attachments) &&
        Objects.equals(this.dates, timeOffRequestBodyCommonProperties.dates) &&
        Objects.equals(this.timeOffPercentage, timeOffRequestBodyCommonProperties.timeOffPercentage);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeOffRequestBodyCommonProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeOffRequestBodyCommonProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeOffRequestBodyCommonProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeOffRequestBodyCommonProperties is not found in the empty JSON string", TimeOffRequestBodyCommonProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeOffRequestBodyCommonProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeOffRequestBodyCommonProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeOffRequestBodyCommonProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeOffRequestBodyCommonProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeOffRequestBodyCommonProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeOffRequestBodyCommonProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeOffRequestBodyCommonProperties>() {
           @Override
           public void write(JsonWriter out, TimeOffRequestBodyCommonProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeOffRequestBodyCommonProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeOffRequestBodyCommonProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeOffRequestBodyCommonProperties
   * @throws IOException if the JSON string is invalid with respect to TimeOffRequestBodyCommonProperties
   */
  public static TimeOffRequestBodyCommonProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeOffRequestBodyCommonProperties.class);
  }

  /**
   * Convert an instance of TimeOffRequestBodyCommonProperties to an JSON string
   *
   * @return JSON string
   */
