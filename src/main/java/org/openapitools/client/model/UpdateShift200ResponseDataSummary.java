...
public class UpdateShift200ResponseDataSummary {
  ...
  public UpdateShift200ResponseDataSummary totalBreakHours(BigDecimal totalBreakHours) {
  ...
  public UpdateShift200ResponseDataSummary payableBreakHours(BigDecimal payableBreakHours) {
  ...
  public UpdateShift200ResponseDataSummary totalPayableHours(BigDecimal totalPayableHours) {
  ...
  public UpdateShift200ResponseDataSummary shiftDurationHours(BigDecimal shiftDurationHours) {
  ...
  public UpdateShift200ResponseDataSummary shiftRateExternalId(String shiftRateExternalId) {
