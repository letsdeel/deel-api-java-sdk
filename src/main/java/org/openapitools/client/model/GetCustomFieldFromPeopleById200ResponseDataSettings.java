...
public class GetCustomFieldFromPeopleById200ResponseDataSettings {
   ...
   */
  @javax.annotation.Nullable
  public GetCustomFieldFromPeopleById200ResponseDataSettingsAccess getAccess() {
    return access;
  }
  ...
  public GetCustomFieldFromPeopleById200ResponseDataSettings addCountriesItem(String countriesItem) {
  ...
  public GetCustomFieldFromPeopleById200ResponseDataSettings addWorkerTypesItem(WorkerTypesEnum workerTypesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetCustomFieldFromPeopleById200ResponseDataSettings getCustomFieldFromPeopleById200ResponseDataSettings = (GetCustomFieldFromPeopleById200ResponseDataSettings) o;
    return Objects.equals(this.access, getCustomFieldFromPeopleById200ResponseDataSettings.access) &&
        Objects.equals(this.required, getCustomFieldFromPeopleById200ResponseDataSettings.required) &&
        Objects.equals(this.countries, getCustomFieldFromPeopleById200ResponseDataSettings.countries) &&
        Objects.equals(this.isEnabled, getCustomFieldFromPeopleById200ResponseDataSettings.isEnabled) &&
        Objects.equals(this.workerTypes, getCustomFieldFromPeopleById200ResponseDataSettings.workerTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCustomFieldFromPeopleById200ResponseDataSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCustomFieldFromPeopleById200ResponseDataSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCustomFieldFromPeopleById200ResponseDataSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCustomFieldFromPeopleById200ResponseDataSettings is not found in the empty JSON string", GetCustomFieldFromPeopleById200ResponseDataSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCustomFieldFromPeopleById200ResponseDataSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCustomFieldFromPeopleById200ResponseDataSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `access`
      if (jsonObj.get("access") != null && !jsonObj.get("access").isJsonNull()) {
        GetCustomFieldFromPeopleById200ResponseDataSettingsAccess.validateJsonElement(jsonObj.get("access"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCustomFieldFromPeopleById200ResponseDataSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCustomFieldFromPeopleById200ResponseDataSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCustomFieldFromPeopleById200ResponseDataSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCustomFieldFromPeopleById200ResponseDataSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCustomFieldFromPeopleById200ResponseDataSettings>() {
           @Override
           public void write(JsonWriter out, GetCustomFieldFromPeopleById200ResponseDataSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCustomFieldFromPeopleById200ResponseDataSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCustomFieldFromPeopleById200ResponseDataSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCustomFieldFromPeopleById200ResponseDataSettings
   * @throws IOException if the JSON string is invalid with respect to GetCustomFieldFromPeopleById200ResponseDataSettings
   */
  public static GetCustomFieldFromPeopleById200ResponseDataSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCustomFieldFromPeopleById200ResponseDataSettings.class);
  }

  /**
   * Convert an instance of GetCustomFieldFromPeopleById200ResponseDataSettings to an JSON string
   *
   * @return JSON string
   */
