...
import org.openapitools.client.model.EntitlementsPolicyTimeOffTypesInner;
...
public class EntitlementsPolicy {
  ...
  @javax.annotation.Nullable
  private List<EntitlementsPolicyTimeOffTypesInner> timeOffTypes = new ArrayList<>();
  ...
  public EntitlementsPolicy() {
  }

  public EntitlementsPolicy id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public EntitlementsPolicy name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public EntitlementsPolicy description(@javax.annotation.Nullable String description) {
  ...
  public EntitlementsPolicy policyTypeId(@javax.annotation.Nullable UUID policyTypeId) {
  ...
  public EntitlementsPolicy trackingUnit(@javax.annotation.Nullable TrackingUnitEnum trackingUnit) {
  ...
  public EntitlementsPolicy trackingUnitAmount(@javax.annotation.Nullable Float trackingUnitAmount) {
  ...
  public EntitlementsPolicy trackingCadence(@javax.annotation.Nullable TrackingCadenceEnum trackingCadence) {
  ...
  public EntitlementsPolicy trackingStartDate(@javax.annotation.Nullable OffsetDateTime trackingStartDate) {
  ...
  public EntitlementsPolicy createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public EntitlementsPolicy updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
  ...
  public EntitlementsPolicy leaveType(@javax.annotation.Nullable LeaveTypeEnum leaveType) {
  ...
  public EntitlementsPolicy timeOffTypes(@javax.annotation.Nullable List<EntitlementsPolicyTimeOffTypesInner> timeOffTypes) {
    this.timeOffTypes = timeOffTypes;
    return this;
  }

  public EntitlementsPolicy addTimeOffTypesItem(EntitlementsPolicyTimeOffTypesInner timeOffTypesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<EntitlementsPolicyTimeOffTypesInner> getTimeOffTypes() {
    return timeOffTypes;
  }

  public void setTimeOffTypes(@javax.annotation.Nullable List<EntitlementsPolicyTimeOffTypesInner> timeOffTypes) {
    this.timeOffTypes = timeOffTypes;
  }


  public EntitlementsPolicy policyType(@javax.annotation.Nullable GetPoliciesForProfile200ResponsePoliciesInnerPolicyType policyType) {
  ...
  public boolean equals(Object o) {
    ...
    EntitlementsPolicy entitlementsPolicy = (EntitlementsPolicy) o;
    return Objects.equals(this.id, entitlementsPolicy.id) &&
        Objects.equals(this.name, entitlementsPolicy.name) &&
        Objects.equals(this.description, entitlementsPolicy.description) &&
        Objects.equals(this.policyTypeId, entitlementsPolicy.policyTypeId) &&
        Objects.equals(this.trackingUnit, entitlementsPolicy.trackingUnit) &&
        Objects.equals(this.trackingUnitAmount, entitlementsPolicy.trackingUnitAmount) &&
        Objects.equals(this.trackingCadence, entitlementsPolicy.trackingCadence) &&
        Objects.equals(this.trackingStartDate, entitlementsPolicy.trackingStartDate) &&
        Objects.equals(this.createdAt, entitlementsPolicy.createdAt) &&
        Objects.equals(this.updatedAt, entitlementsPolicy.updatedAt) &&
        Objects.equals(this.leaveType, entitlementsPolicy.leaveType) &&
        Objects.equals(this.timeOffTypes, entitlementsPolicy.timeOffTypes) &&
        Objects.equals(this.policyType, entitlementsPolicy.policyType);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntitlementsPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntitlementsPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntitlementsPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntitlementsPolicy is not found in the empty JSON string", EntitlementsPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntitlementsPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntitlementsPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EntitlementsPolicy.openapiRequiredFields) {
      ...
      if (jsonObj.get("time_off_types") != null && !jsonObj.get("time_off_types").isJsonNull()) {
        ...
        if (jsonArraytimeOffTypes != null) {
          ...
          for (int i = 0; i < jsonArraytimeOffTypes.size(); i++) {
            EntitlementsPolicyTimeOffTypesInner.validateJsonElement(jsonArraytimeOffTypes.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntitlementsPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntitlementsPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntitlementsPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntitlementsPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<EntitlementsPolicy>() {
           @Override
           public void write(JsonWriter out, EntitlementsPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntitlementsPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntitlementsPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntitlementsPolicy
   * @throws IOException if the JSON string is invalid with respect to EntitlementsPolicy
   */
  public static EntitlementsPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntitlementsPolicy.class);
  }

  /**
   * Convert an instance of EntitlementsPolicy to an JSON string
   *
   * @return JSON string
   */
