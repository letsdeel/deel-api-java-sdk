...
public class InvoiceAdjustment {
  ...
  public InvoiceAdjustment id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public InvoiceAdjustment type(@javax.annotation.Nonnull InvoiceAdjustmentTypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public InvoiceAdjustment status(@javax.annotation.Nullable InvoiceAdjustmentStatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public InvoiceAdjustment description(@javax.annotation.Nonnull String description) {
  ...
  public InvoiceAdjustment dateSubmitted(@javax.annotation.Nonnull OffsetDateTime dateSubmitted) {
  ...
  public InvoiceAdjustment currencyCode(@javax.annotation.Nonnull String currencyCode) {
  ...
  public InvoiceAdjustment invoiceId(@javax.annotation.Nullable BigDecimal invoiceId) {
  ...
  public InvoiceAdjustment quantity(@javax.annotation.Nullable BigDecimal quantity) {
  ...
  public InvoiceAdjustment totalAmount(@javax.annotation.Nonnull String totalAmount) {
  ...
  public InvoiceAdjustment createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public InvoiceAdjustment scale(@javax.annotation.Nullable String scale) {
    this.scale = scale;
    return this;
  }
  ...
  public InvoiceAdjustment customScale(@javax.annotation.Nullable String customScale) {
  ...
  public InvoiceAdjustment attachment(@javax.annotation.Nullable FileAttachmentInfo attachment) {
  ...
  public InvoiceAdjustment worksheet(@javax.annotation.Nullable BasicTimesheetWorksheet worksheet) {
  ...
  public InvoiceAdjustment reviewedBy(@javax.annotation.Nullable BasicTimesheetReviewedBy reviewedBy) {
  ...
  public InvoiceAdjustment contract(@javax.annotation.Nonnull BasicTimesheetContract contract) {
  ...
  public InvoiceAdjustment paymentCycle(@javax.annotation.Nonnull BasicInvoiceAdjustmentPaymentCycle paymentCycle) {
  ...
  public InvoiceAdjustment reportedBy(@javax.annotation.Nonnull BasicTimesheetReportedBy reportedBy) {
  ...
  public InvoiceAdjustment approvers(@javax.annotation.Nonnull List<InvoiceAdjustmentApprover> approvers) {
    this.approvers = approvers;
    return this;
  }

  public InvoiceAdjustment addApproversItem(InvoiceAdjustmentApprover approversItem) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceAdjustment invoiceAdjustment = (InvoiceAdjustment) o;
    return Objects.equals(this.id, invoiceAdjustment.id) &&
        Objects.equals(this.type, invoiceAdjustment.type) &&
        Objects.equals(this.status, invoiceAdjustment.status) &&
        Objects.equals(this.description, invoiceAdjustment.description) &&
        Objects.equals(this.dateSubmitted, invoiceAdjustment.dateSubmitted) &&
        Objects.equals(this.currencyCode, invoiceAdjustment.currencyCode) &&
        Objects.equals(this.invoiceId, invoiceAdjustment.invoiceId) &&
        Objects.equals(this.quantity, invoiceAdjustment.quantity) &&
        Objects.equals(this.totalAmount, invoiceAdjustment.totalAmount) &&
        Objects.equals(this.createdAt, invoiceAdjustment.createdAt) &&
        Objects.equals(this.scale, invoiceAdjustment.scale) &&
        Objects.equals(this.customScale, invoiceAdjustment.customScale) &&
        Objects.equals(this.attachment, invoiceAdjustment.attachment) &&
        Objects.equals(this.worksheet, invoiceAdjustment.worksheet) &&
        Objects.equals(this.reviewedBy, invoiceAdjustment.reviewedBy) &&
        Objects.equals(this.contract, invoiceAdjustment.contract) &&
        Objects.equals(this.paymentCycle, invoiceAdjustment.paymentCycle) &&
        Objects.equals(this.reportedBy, invoiceAdjustment.reportedBy) &&
        Objects.equals(this.approvers, invoiceAdjustment.approvers);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, status, description, dateSubmitted, currencyCode, invoiceId, quantity, totalAmount, createdAt, scale, customScale, attachment, worksheet, reviewedBy, contract, paymentCycle, reportedBy, approvers);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InvoiceAdjustment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvoiceAdjustment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceAdjustment is not found in the empty JSON string", InvoiceAdjustment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvoiceAdjustment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InvoiceAdjustment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvoiceAdjustment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceAdjustment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceAdjustment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceAdjustment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceAdjustment.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceAdjustment>() {
           @Override
           public void write(JsonWriter out, InvoiceAdjustment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InvoiceAdjustment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InvoiceAdjustment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InvoiceAdjustment
   * @throws IOException if the JSON string is invalid with respect to InvoiceAdjustment
   */
  public static InvoiceAdjustment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceAdjustment.class);
  }

  /**
   * Convert an instance of InvoiceAdjustment to an JSON string
   *
   * @return JSON string
   */
