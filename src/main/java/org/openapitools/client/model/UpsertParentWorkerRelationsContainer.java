...
public class UpsertParentWorkerRelationsContainer {
  ...
  public UpsertParentWorkerRelationsContainer data(UpsertParentWorkerRelationsContainerData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(UpsertParentWorkerRelationsContainerData data) {
    this.data = data;
  }
