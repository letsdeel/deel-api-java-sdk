...
public class CreateDirectEmployeeRequestEmployee {
  ...
  public CreateDirectEmployeeRequestEmployee email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CreateDirectEmployeeRequestEmployee state(String state) {
    this.state = state;
    return this;
  }
  ...
  public CreateDirectEmployeeRequestEmployee country(String country) {
  ...
  public CreateDirectEmployeeRequestEmployee lastName(String lastName) {
  ...
  public CreateDirectEmployeeRequestEmployee firstName(String firstName) {
  ...
  public CreateDirectEmployeeRequestEmployee workEmail(String workEmail) {
  ...
  public CreateDirectEmployeeRequestEmployee nationality(String nationality) {
