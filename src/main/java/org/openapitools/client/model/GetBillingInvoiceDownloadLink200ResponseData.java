...
public class GetBillingInvoiceDownloadLink200ResponseData {
  ...
  public GetBillingInvoiceDownloadLink200ResponseData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetBillingInvoiceDownloadLink200ResponseData url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GetBillingInvoiceDownloadLink200ResponseData expiresAt(OffsetDateTime expiresAt) {
