...
public class ProfileReference {
  ...
  public ProfileReference hrisProfileId(UUID hrisProfileId) {
  ...
  public ProfileReference organizationId(UUID organizationId) {
  ...
  public ProfileReference clientProfileId(UUID clientProfileId) {
