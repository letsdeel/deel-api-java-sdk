...
public class CustomFieldToUpdateContainer {
  ...
  public CustomFieldToUpdateContainer id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CustomFieldToUpdateContainer data(CustomFieldToUpdateContainerData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(CustomFieldToUpdateContainerData data) {
    this.data = data;
  }
