...
public class Policy {
  ...
  public Policy policyTypeId(UUID policyTypeId) {
  ...
  public Policy trackingUnit(TrackingUnitEnum trackingUnit) {
  ...
  public Policy trackingUnitAmount(Float trackingUnitAmount) {
  ...
  public Policy trackingCadence(TrackingCadenceEnum trackingCadence) {
  ...
  public Policy trackingStartDate(OffsetDateTime trackingStartDate) {
  ...
  public Policy leaveType(LeaveTypeEnum leaveType) {
  ...
  public Policy timeOffTypes(List<TimeOffType> timeOffTypes) {
  ...
  public Policy policyType(GetPoliciesForProfile200ResponsePoliciesInnerPolicyType policyType) {
