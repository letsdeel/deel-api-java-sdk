...
public class MilestoneToCreateFormWithFile {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, milestoneToCreateFormWithFile.amount) &&
        Objects.equals(this.title, milestoneToCreateFormWithFile.title) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to MilestoneToCreateFormWithFile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MilestoneToCreateFormWithFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MilestoneToCreateFormWithFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MilestoneToCreateFormWithFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
