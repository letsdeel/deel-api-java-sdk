...
public class BenefitQuote {
  ...
  public BenefitQuote fee(@javax.annotation.Nullable BigDecimal fee) {
    this.fee = fee;
    return this;
  }
  ...
  public BenefitQuote feeUsd(@javax.annotation.Nullable BigDecimal feeUsd) {
    this.feeUsd = feeUsd;
    return this;
  }
  ...
  public BenefitQuote name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public BenefitQuote plan(@javax.annotation.Nullable String plan) {
    this.plan = plan;
    return this;
  }
  ...
  public BenefitQuote price(@javax.annotation.Nullable BigDecimal price) {
    this.price = price;
    return this;
  }
  ...
  public BenefitQuote currency(@javax.annotation.Nullable String currency) {
  ...
  public BenefitQuote priceUsd(@javax.annotation.Nullable BigDecimal priceUsd) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fee, feeUsd, name, plan, price, currency, priceUsd);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BenefitQuote
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BenefitQuote.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BenefitQuote.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BenefitQuote` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
