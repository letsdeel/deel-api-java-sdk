...
public class GetCustomFieldValuesFromWorker200ResponseDataInnerData extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetCustomFieldValuesFromWorker200ResponseDataInnerData.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetCustomFieldValuesFromWorker200ResponseDataInnerData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetCustomFieldValuesFromWorker200ResponseDataInnerData' and its subtypes
            }
            ...
            final TypeAdapter<GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4> adapterGetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4 = gson.getDelegateAdapter(this, TypeToken.get(GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetCustomFieldValuesFromWorker200ResponseDataInnerData>() {
                @Override
                public void write(JsonWriter out, GetCustomFieldValuesFromWorker200ResponseDataInnerData value) throws IOException {
                    ...
                    // check if the actual instance is of the type `GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4`
                    if (value.getActualInstance() instanceof GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4) {
                        JsonElement element = adapterGetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4.toJsonTree((GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                public GetCustomFieldValuesFromWorker200ResponseDataInnerData read(JsonReader in) throws IOException {
                    ...
                    // deserialize GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4
                    try {
                        // validate the JSON object to see if any exception is thrown
                        GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4.validateJsonElement(jsonElement);
                        actualAdapter = adapterGetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4'", e);
                    }
                    ...
                    if (match == 1) {
                        GetCustomFieldValuesFromWorker200ResponseDataInnerData ret = new GetCustomFieldValuesFromWorker200ResponseDataInnerData();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetCustomFieldValuesFromWorker200ResponseDataInnerData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetCustomFieldValuesFromWorker200ResponseDataInnerData() {
        super("oneOf", Boolean.FALSE);
    }

    public GetCustomFieldValuesFromWorker200ResponseDataInnerData(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4", GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4.class);
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetCustomFieldValuesFromWorker200ResponseDataInnerData.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf1, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf2, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf3, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf5, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf6
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf1, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf2, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf3, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf5, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf6");
    }
     ...
     * GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf1, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf2, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf3, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf5, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf6
     *
     * @return The actual instance (GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf1, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf2, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf3, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf5, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf6)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4`. If the actual instance is not `GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4`
     * @throws ClassCastException if the instance is not `GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4`
     */
    public GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4 getGetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4() throws ClassCastException {
        return (GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4)super.getActualInstance();
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetCustomFieldValuesFromWorker200ResponseDataInnerData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4
        try {
            GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for GetCustomFieldValuesFromWorker200ResponseDataInnerData with oneOf schemas: GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf1, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf2, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf3, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf4, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf5, GetCustomFieldValuesFromWorker200ResponseDataInnerDataOneOf6. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of GetCustomFieldValuesFromWorker200ResponseDataInnerData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetCustomFieldValuesFromWorker200ResponseDataInnerData
     * @throws IOException if the JSON string is invalid with respect to GetCustomFieldValuesFromWorker200ResponseDataInnerData
     */
    public static GetCustomFieldValuesFromWorker200ResponseDataInnerData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetCustomFieldValuesFromWorker200ResponseDataInnerData.class);
    }

    /**
     * Convert an instance of GetCustomFieldValuesFromWorker200ResponseDataInnerData to an JSON string
     *
     * @return JSON string
     */
