...
public class GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData {
  ...
  public GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData expiresAt(OffsetDateTime expiresAt) {
