...
public class GetMilestonesByContract200ResponseDataInnerReviewedBy {
  ...
  public GetMilestonesByContract200ResponseDataInnerReviewedBy id(GetMilestonesByContract200ResponseDataInnerReviewedById id) {
    this.id = id;
    return this;
  }
  ...
  public void setId(GetMilestonesByContract200ResponseDataInnerReviewedById id) {
    this.id = id;
  }


  public GetMilestonesByContract200ResponseDataInnerReviewedBy fullName(String fullName) {
