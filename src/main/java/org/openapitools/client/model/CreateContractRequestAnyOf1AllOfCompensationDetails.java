...
public class CreateContractRequestAnyOf1AllOfCompensationDetails {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails() {
  }

  public CreateContractRequestAnyOf1AllOfCompensationDetails amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails cycleEnd(BigDecimal cycleEnd) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails frequency(FrequencyEnum frequency) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails currencyCode(String currencyCode) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails firstPayment(BigDecimal firstPayment) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails noticePeriod(BigDecimal noticePeriod) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails cycleEndType(CycleEndTypeEnum cycleEndType) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails paymentDueDays(BigDecimal paymentDueDays) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails paymentDueType(PaymentDueTypeEnum paymentDueType) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails firstPaymentDate(LocalDate firstPaymentDate) {
  ...
  public CreateContractRequestAnyOf1AllOfCompensationDetails payBeforeWeekends(Boolean payBeforeWeekends) {
  ...
  public boolean equals(Object o) {
    ...
    CreateContractRequestAnyOf1AllOfCompensationDetails createContractRequestAnyOf1AllOfCompensationDetails = (CreateContractRequestAnyOf1AllOfCompensationDetails) o;
    return Objects.equals(this.amount, createContractRequestAnyOf1AllOfCompensationDetails.amount) &&
        Objects.equals(this.cycleEnd, createContractRequestAnyOf1AllOfCompensationDetails.cycleEnd) &&
        Objects.equals(this.frequency, createContractRequestAnyOf1AllOfCompensationDetails.frequency) &&
        Objects.equals(this.currencyCode, createContractRequestAnyOf1AllOfCompensationDetails.currencyCode) &&
        Objects.equals(this.firstPayment, createContractRequestAnyOf1AllOfCompensationDetails.firstPayment) &&
        Objects.equals(this.noticePeriod, createContractRequestAnyOf1AllOfCompensationDetails.noticePeriod) &&
        Objects.equals(this.cycleEndType, createContractRequestAnyOf1AllOfCompensationDetails.cycleEndType) &&
        Objects.equals(this.paymentDueDays, createContractRequestAnyOf1AllOfCompensationDetails.paymentDueDays) &&
        Objects.equals(this.paymentDueType, createContractRequestAnyOf1AllOfCompensationDetails.paymentDueType) &&
        Objects.equals(this.firstPaymentDate, createContractRequestAnyOf1AllOfCompensationDetails.firstPaymentDate) &&
        Objects.equals(this.payBeforeWeekends, createContractRequestAnyOf1AllOfCompensationDetails.payBeforeWeekends);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateContractRequestAnyOf1AllOfCompensationDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateContractRequestAnyOf1AllOfCompensationDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateContractRequestAnyOf1AllOfCompensationDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateContractRequestAnyOf1AllOfCompensationDetails is not found in the empty JSON string", CreateContractRequestAnyOf1AllOfCompensationDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateContractRequestAnyOf1AllOfCompensationDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateContractRequestAnyOf1AllOfCompensationDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateContractRequestAnyOf1AllOfCompensationDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateContractRequestAnyOf1AllOfCompensationDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateContractRequestAnyOf1AllOfCompensationDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateContractRequestAnyOf1AllOfCompensationDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateContractRequestAnyOf1AllOfCompensationDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateContractRequestAnyOf1AllOfCompensationDetails>() {
           @Override
           public void write(JsonWriter out, CreateContractRequestAnyOf1AllOfCompensationDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateContractRequestAnyOf1AllOfCompensationDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateContractRequestAnyOf1AllOfCompensationDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateContractRequestAnyOf1AllOfCompensationDetails
   * @throws IOException if the JSON string is invalid with respect to CreateContractRequestAnyOf1AllOfCompensationDetails
   */
  public static CreateContractRequestAnyOf1AllOfCompensationDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateContractRequestAnyOf1AllOfCompensationDetails.class);
  }

  /**
   * Convert an instance of CreateContractRequestAnyOf1AllOfCompensationDetails to an JSON string
   *
   * @return JSON string
   */
