...
public class CreateWebhookRequest {
  ...
  public CreateWebhookRequest status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public CreateWebhookRequest signingKey(String signingKey) {
  ...
  public CreateWebhookRequest apiVersion(String apiVersion) {
