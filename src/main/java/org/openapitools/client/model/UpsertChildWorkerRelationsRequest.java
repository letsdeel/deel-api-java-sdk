...
public class UpsertChildWorkerRelationsRequest {
  ...
  public UpsertChildWorkerRelationsRequest data(UpsertChildWorkerRelationsRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(UpsertChildWorkerRelationsRequestData data) {
    this.data = data;
  }
