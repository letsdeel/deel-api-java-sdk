...
public class BasicTimesheet {
  ...
  public BasicTimesheet() {
  }

  public BasicTimesheet id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public BasicTimesheet type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public BasicTimesheet status(@javax.annotation.Nullable TimesheetStatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public BasicTimesheet description(@javax.annotation.Nonnull String description) {
  ...
  public BasicTimesheet dateSubmitted(@javax.annotation.Nonnull OffsetDateTime dateSubmitted) {
  ...
  public BasicTimesheet currencyCode(@javax.annotation.Nonnull String currencyCode) {
  ...
  public BasicTimesheet totalAmount(@javax.annotation.Nonnull String totalAmount) {
  ...
  public BasicTimesheet quantity(@javax.annotation.Nullable BigDecimal quantity) {
  ...
  public BasicTimesheet createdAt(@javax.annotation.Nonnull String createdAt) {
  ...
  public BasicTimesheet scale(@javax.annotation.Nullable String scale) {
    this.scale = scale;
    return this;
  }
  ...
  public BasicTimesheet customScale(@javax.annotation.Nullable String customScale) {
  ...
  public BasicTimesheet attachment(@javax.annotation.Nullable FileAttachmentInfo attachment) {
  ...
  public BasicTimesheet worksheet(@javax.annotation.Nullable BasicTimesheetWorksheet worksheet) {
  ...
  public BasicTimesheet reviewedBy(@javax.annotation.Nullable BasicTimesheetReviewedBy reviewedBy) {
  ...
  public BasicTimesheet contract(@javax.annotation.Nonnull BasicTimesheetContract contract) {
  ...
  public BasicTimesheet paymentCycle(@javax.annotation.Nullable BasicTimesheetPaymentCycle paymentCycle) {
  ...
  public BasicTimesheet reportedBy(@javax.annotation.Nonnull BasicTimesheetReportedBy reportedBy) {
  ...
  public boolean equals(Object o) {
    ...
    BasicTimesheet basicTimesheet = (BasicTimesheet) o;
    return Objects.equals(this.id, basicTimesheet.id) &&
        Objects.equals(this.type, basicTimesheet.type) &&
        Objects.equals(this.status, basicTimesheet.status) &&
        Objects.equals(this.description, basicTimesheet.description) &&
        Objects.equals(this.dateSubmitted, basicTimesheet.dateSubmitted) &&
        Objects.equals(this.currencyCode, basicTimesheet.currencyCode) &&
        Objects.equals(this.totalAmount, basicTimesheet.totalAmount) &&
        Objects.equals(this.quantity, basicTimesheet.quantity) &&
        Objects.equals(this.createdAt, basicTimesheet.createdAt) &&
        Objects.equals(this.scale, basicTimesheet.scale) &&
        Objects.equals(this.customScale, basicTimesheet.customScale) &&
        Objects.equals(this.attachment, basicTimesheet.attachment) &&
        Objects.equals(this.worksheet, basicTimesheet.worksheet) &&
        Objects.equals(this.reviewedBy, basicTimesheet.reviewedBy) &&
        Objects.equals(this.contract, basicTimesheet.contract) &&
        Objects.equals(this.paymentCycle, basicTimesheet.paymentCycle) &&
        Objects.equals(this.reportedBy, basicTimesheet.reportedBy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, status, description, dateSubmitted, currencyCode, totalAmount, quantity, createdAt, scale, customScale, attachment, worksheet, reviewedBy, contract, paymentCycle, reportedBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class BasicTimesheet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BasicTimesheet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BasicTimesheet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BasicTimesheet is not found in the empty JSON string", BasicTimesheet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BasicTimesheet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BasicTimesheet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BasicTimesheet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BasicTimesheet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BasicTimesheet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BasicTimesheet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BasicTimesheet.class));

       return (TypeAdapter<T>) new TypeAdapter<BasicTimesheet>() {
           @Override
           public void write(JsonWriter out, BasicTimesheet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BasicTimesheet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BasicTimesheet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BasicTimesheet
   * @throws IOException if the JSON string is invalid with respect to BasicTimesheet
   */
  public static BasicTimesheet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BasicTimesheet.class);
  }

  /**
   * Convert an instance of BasicTimesheet to an JSON string
   *
   * @return JSON string
   */
