...
public class CreateCaseRequest {
  ...
  private CreateCaseRequestData data;

  public CreateCaseRequest() {
  }

  public CreateCaseRequest data(@javax.annotation.Nullable CreateCaseRequestData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CreateCaseRequestData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable CreateCaseRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createCaseRequest.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CreateCaseRequestData.validateJsonElement(jsonObj.get("data"));
      }
  }
