...
import org.openapitools.client.model.CompensationDetailsOfContractToCreateShared;
...
public class ContractToCreatePaygTasks {
  ...
  public ContractToCreatePaygTasks title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public ContractToCreatePaygTasks countryCode(@javax.annotation.Nullable String countryCode) {
  ...
  public ContractToCreatePaygTasks stateCode(@javax.annotation.Nullable String stateCode) {
  ...
  public ContractToCreatePaygTasks scopeOfWork(@javax.annotation.Nullable String scopeOfWork) {
  ...
  public ContractToCreatePaygTasks specialClause(@javax.annotation.Nullable String specialClause) {
  ...
  public ContractToCreatePaygTasks terminationDate(@javax.annotation.Nullable LocalDate terminationDate) {
  ...
  public ContractToCreatePaygTasks client(@javax.annotation.Nonnull ContractToCreateSharedClient client) {
    this.client = client;
    return this;
  }
  ...
  public ContractToCreatePaygTasks jobTitle(@javax.annotation.Nonnull ContractToCreateSharedJobTitle jobTitle) {
  ...
  public ContractToCreatePaygTasks seniority(@javax.annotation.Nullable ContractToCreateSharedSeniority seniority) {
  ...
  public ContractToCreatePaygTasks noticePeriod(@javax.annotation.Nullable BigDecimal noticePeriod) {
  ...
  public ContractToCreatePaygTasks whoReports(@javax.annotation.Nullable ContractWhoReportsEnum whoReports) {
  ...
  public ContractToCreatePaygTasks meta(@javax.annotation.Nonnull MetaDataOfContractToCreate meta) {
    this.meta = meta;
    return this;
  }
  ...
  public ContractToCreatePaygTasks externalId(@javax.annotation.Nullable String externalId) {
  ...
  public ContractToCreatePaygTasks worker(@javax.annotation.Nullable ContractToCreateSharedWorker worker) {
    this.worker = worker;
    return this;
  }
  ...
  public ContractToCreatePaygTasks type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ContractToCreatePaygTasks startDate(@javax.annotation.Nonnull LocalDate startDate) {
  ...
  public ContractToCreatePaygTasks compensationDetails(@javax.annotation.Nonnull CompensationDetailsOfContractToCreateShared compensationDetails) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContractToCreatePaygTasks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContractToCreatePaygTasks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContractToCreatePaygTasks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContractToCreatePaygTasks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      CompensationDetailsOfContractToCreateShared.validateJsonElement(jsonObj.get("compensation_details"));
  }
