...
public class TimesheetSharedProperties {
  ...
  public TimesheetSharedProperties contractId(String contractId) {
  ...
  public TimesheetSharedProperties description(String description) {
  ...
  public TimesheetSharedProperties dateSubmitted(LocalDate dateSubmitted) {
  ...
  public TimesheetSharedProperties quantity(BigDecimal quantity) {
