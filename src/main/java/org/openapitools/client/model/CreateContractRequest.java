...
import org.openapitools.client.model.CreateContractRequestData;
...
public class CreateContractRequest {
  ...
  private CreateContractRequestData data;

  public CreateContractRequest() {
  }

  public CreateContractRequest data(@javax.annotation.Nonnull CreateContractRequestData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public CreateContractRequestData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nonnull CreateContractRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createContractRequest.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateContractRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateContractRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateContractRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      CreateContractRequestData.validateJsonElement(jsonObj.get("data"));
  }
