...
public class CreateContractRequestAnyOfAllOfCompensationDetails {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails() {
  }

  public CreateContractRequestAnyOfAllOfCompensationDetails amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails cycleEnd(BigDecimal cycleEnd) {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails frequency(FrequencyEnum frequency) {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails currencyCode(String currencyCode) {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails firstPayment(BigDecimal firstPayment) {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails noticePeriod(BigDecimal noticePeriod) {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails cycleEndType(CycleEndTypeEnum cycleEndType) {
  ...
  public void setCycleEndType(CycleEndTypeEnum cycleEndType) {
    this.cycleEndType = cycleEndType;
  }


  public CreateContractRequestAnyOfAllOfCompensationDetails paymentDueDays(BigDecimal paymentDueDays) {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails paymentDueType(PaymentDueTypeEnum paymentDueType) {
  ...
  public void setPaymentDueType(PaymentDueTypeEnum paymentDueType) {
    this.paymentDueType = paymentDueType;
  }


  public CreateContractRequestAnyOfAllOfCompensationDetails firstPaymentDate(LocalDate firstPaymentDate) {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails payBeforeWeekends(Boolean payBeforeWeekends) {
  ...
  public CreateContractRequestAnyOfAllOfCompensationDetails scale(ScaleEnum scale) {
    this.scale = scale;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateContractRequestAnyOfAllOfCompensationDetails createContractRequestAnyOfAllOfCompensationDetails = (CreateContractRequestAnyOfAllOfCompensationDetails) o;
    return Objects.equals(this.amount, createContractRequestAnyOfAllOfCompensationDetails.amount) &&
        Objects.equals(this.cycleEnd, createContractRequestAnyOfAllOfCompensationDetails.cycleEnd) &&
        Objects.equals(this.frequency, createContractRequestAnyOfAllOfCompensationDetails.frequency) &&
        Objects.equals(this.currencyCode, createContractRequestAnyOfAllOfCompensationDetails.currencyCode) &&
        Objects.equals(this.firstPayment, createContractRequestAnyOfAllOfCompensationDetails.firstPayment) &&
        Objects.equals(this.noticePeriod, createContractRequestAnyOfAllOfCompensationDetails.noticePeriod) &&
        Objects.equals(this.cycleEndType, createContractRequestAnyOfAllOfCompensationDetails.cycleEndType) &&
        Objects.equals(this.paymentDueDays, createContractRequestAnyOfAllOfCompensationDetails.paymentDueDays) &&
        Objects.equals(this.paymentDueType, createContractRequestAnyOfAllOfCompensationDetails.paymentDueType) &&
        Objects.equals(this.firstPaymentDate, createContractRequestAnyOfAllOfCompensationDetails.firstPaymentDate) &&
        Objects.equals(this.payBeforeWeekends, createContractRequestAnyOfAllOfCompensationDetails.payBeforeWeekends) &&
        Objects.equals(this.scale, createContractRequestAnyOfAllOfCompensationDetails.scale);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateContractRequestAnyOfAllOfCompensationDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateContractRequestAnyOfAllOfCompensationDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateContractRequestAnyOfAllOfCompensationDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateContractRequestAnyOfAllOfCompensationDetails is not found in the empty JSON string", CreateContractRequestAnyOfAllOfCompensationDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateContractRequestAnyOfAllOfCompensationDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateContractRequestAnyOfAllOfCompensationDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateContractRequestAnyOfAllOfCompensationDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateContractRequestAnyOfAllOfCompensationDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateContractRequestAnyOfAllOfCompensationDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateContractRequestAnyOfAllOfCompensationDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateContractRequestAnyOfAllOfCompensationDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateContractRequestAnyOfAllOfCompensationDetails>() {
           @Override
           public void write(JsonWriter out, CreateContractRequestAnyOfAllOfCompensationDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateContractRequestAnyOfAllOfCompensationDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateContractRequestAnyOfAllOfCompensationDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateContractRequestAnyOfAllOfCompensationDetails
   * @throws IOException if the JSON string is invalid with respect to CreateContractRequestAnyOfAllOfCompensationDetails
   */
  public static CreateContractRequestAnyOfAllOfCompensationDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateContractRequestAnyOfAllOfCompensationDetails.class);
  }

  /**
   * Convert an instance of CreateContractRequestAnyOfAllOfCompensationDetails to an JSON string
   *
   * @return JSON string
   */
