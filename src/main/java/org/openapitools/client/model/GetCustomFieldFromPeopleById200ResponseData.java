...
public class GetCustomFieldFromPeopleById200ResponseData {
  ...
  public GetCustomFieldFromPeopleById200ResponseData id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public GetCustomFieldFromPeopleById200ResponseData name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetCustomFieldFromPeopleById200ResponseData type(GetCustomFieldFromPeopleById200ResponseDataType type) {
    this.type = type;
    return this;
  }
  ...
  public GetCustomFieldFromPeopleById200ResponseData settings(GetCustomFieldFromPeopleById200ResponseDataSettings settings) {
  ...
  public GetCustomFieldFromPeopleById200ResponseData placement(PlacementEnum placement) {
  ...
  public GetCustomFieldFromPeopleById200ResponseData createdAt(LocalDate createdAt) {
  ...
  public GetCustomFieldFromPeopleById200ResponseData description(String description) {
