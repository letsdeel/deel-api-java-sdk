...
public class PAYGMILESTONES {
  ...
  public PAYGMILESTONES() {
  }

  public PAYGMILESTONES meta(@javax.annotation.Nonnull PAYASYOUGOTIMEBASEDAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public PAYGMILESTONES title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public PAYGMILESTONES client(@javax.annotation.Nonnull PAYASYOUGOTIMEBASEDAllOfClient client) {
    this.client = client;
    return this;
  }
  ...
  public PAYGMILESTONES worker(@javax.annotation.Nullable PAYASYOUGOTIMEBASEDAllOfWorker worker) {
    this.worker = worker;
    return this;
  }
  ...
  public PAYGMILESTONES jobTitle(@javax.annotation.Nonnull PAYASYOUGOTIMEBASEDAllOfJobTitle jobTitle) {
  ...
  public PAYGMILESTONES seniority(@javax.annotation.Nullable PAYASYOUGOTIMEBASEDAllOfSeniority seniority) {
  ...
  public PAYGMILESTONES stateCode(@javax.annotation.Nullable String stateCode) {
  ...
  public PAYGMILESTONES externalId(@javax.annotation.Nullable String externalId) {
  ...
  public PAYGMILESTONES whoReports(@javax.annotation.Nullable WhoReportsEnum whoReports) {
  ...
  public PAYGMILESTONES countryCode(@javax.annotation.Nullable String countryCode) {
  ...
  public PAYGMILESTONES noticePeriod(@javax.annotation.Nullable BigDecimal noticePeriod) {
  ...
  public PAYGMILESTONES scopeOfWork(@javax.annotation.Nullable String scopeOfWork) {
  ...
  public PAYGMILESTONES specialClause(@javax.annotation.Nullable String specialClause) {
  ...
  public PAYGMILESTONES terminationDate(@javax.annotation.Nullable LocalDate terminationDate) {
  ...
  public PAYGMILESTONES type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public PAYGMILESTONES startDate(@javax.annotation.Nullable LocalDate startDate) {
  ...
  public PAYGMILESTONES compensationDetails(@javax.annotation.Nonnull PAYGTASKSAllOfCompensationDetails compensationDetails) {
  ...
  public boolean equals(Object o) {
    ...
    PAYGMILESTONES PAYG_MILESTONES = (PAYGMILESTONES) o;
    return Objects.equals(this.meta, PAYG_MILESTONES.meta) &&
        Objects.equals(this.title, PAYG_MILESTONES.title) &&
        Objects.equals(this.client, PAYG_MILESTONES.client) &&
        Objects.equals(this.worker, PAYG_MILESTONES.worker) &&
        Objects.equals(this.jobTitle, PAYG_MILESTONES.jobTitle) &&
        Objects.equals(this.seniority, PAYG_MILESTONES.seniority) &&
        Objects.equals(this.stateCode, PAYG_MILESTONES.stateCode) &&
        Objects.equals(this.externalId, PAYG_MILESTONES.externalId) &&
        Objects.equals(this.whoReports, PAYG_MILESTONES.whoReports) &&
        Objects.equals(this.countryCode, PAYG_MILESTONES.countryCode) &&
        Objects.equals(this.noticePeriod, PAYG_MILESTONES.noticePeriod) &&
        Objects.equals(this.scopeOfWork, PAYG_MILESTONES.scopeOfWork) &&
        Objects.equals(this.specialClause, PAYG_MILESTONES.specialClause) &&
        Objects.equals(this.terminationDate, PAYG_MILESTONES.terminationDate) &&
        Objects.equals(this.type, PAYG_MILESTONES.type) &&
        Objects.equals(this.startDate, PAYG_MILESTONES.startDate) &&
        Objects.equals(this.compensationDetails, PAYG_MILESTONES.compensationDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class PAYGMILESTONES {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PAYGMILESTONES
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PAYGMILESTONES.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PAYGMILESTONES is not found in the empty JSON string", PAYGMILESTONES.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PAYGMILESTONES.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PAYGMILESTONES` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PAYGMILESTONES.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PAYGMILESTONES.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PAYGMILESTONES' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PAYGMILESTONES> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PAYGMILESTONES.class));

       return (TypeAdapter<T>) new TypeAdapter<PAYGMILESTONES>() {
           @Override
           public void write(JsonWriter out, PAYGMILESTONES value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PAYGMILESTONES read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PAYGMILESTONES given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PAYGMILESTONES
   * @throws IOException if the JSON string is invalid with respect to PAYGMILESTONES
   */
  public static PAYGMILESTONES fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PAYGMILESTONES.class);
  }

  /**
   * Convert an instance of PAYGMILESTONES to an JSON string
   *
   * @return JSON string
   */
