...
public class CreatedExerciseEquityContainer {
  ...
  public CreatedExerciseEquityContainer id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CreatedExerciseEquityContainer status(String status) {
    this.status = status;
    return this;
  }
  ...
  public CreatedExerciseEquityContainer createdAt(OffsetDateTime createdAt) {
  ...
  public CreatedExerciseEquityContainer updatedAt(OffsetDateTime updatedAt) {
  ...
  public CreatedExerciseEquityContainer employerApproval(String employerApproval) {
