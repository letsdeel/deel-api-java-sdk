...
public class UpdateTimeOffRequestDataAttachmentsInner {
  ...
  public UpdateTimeOffRequestDataAttachmentsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UpdateTimeOffRequestDataAttachmentsInner key(String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateTimeOffRequestDataAttachmentsInner filename(String filename) {
  ...
  public UpdateTimeOffRequestDataAttachmentsInner uploadId(String uploadId) {
