...
public class PatchGpBankAccount200ResponseData {
  ...
  public PatchGpBankAccount200ResponseData id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public PatchGpBankAccount200ResponseData status(String status) {
    this.status = status;
    return this;
  }
  ...
  public PatchGpBankAccount200ResponseData createdAt(OffsetDateTime createdAt) {
  ...
  public PatchGpBankAccount200ResponseData updatedAt(OffsetDateTime updatedAt) {
