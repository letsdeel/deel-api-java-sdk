...
public class ContractSearchFormWithoutCursorTypes extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ContractSearchFormWithoutCursorTypes.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ContractSearchFormWithoutCursorTypes.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ContractSearchFormWithoutCursorTypes' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ContractSearchFormWithoutCursorTypes>() {
                @Override
                public void write(JsonWriter out, ContractSearchFormWithoutCursorTypes value) throws IOException {
                ...
                @Override
                public ContractSearchFormWithoutCursorTypes read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ContractSearchFormWithoutCursorTypes ret = new ContractSearchFormWithoutCursorTypes();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ContractSearchFormWithoutCursorTypes: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ContractSearchFormWithoutCursorTypes() {
        super("oneOf", Boolean.FALSE);
    }

    public ContractSearchFormWithoutCursorTypes(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ContractSearchFormWithoutCursorTypes.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ContractSearchFormWithoutCursorTypes
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ContractSearchFormWithoutCursorTypes with oneOf schemas: ContractTypeEnum, List<ContractTypeEnum>. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ContractSearchFormWithoutCursorTypes given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ContractSearchFormWithoutCursorTypes
     * @throws IOException if the JSON string is invalid with respect to ContractSearchFormWithoutCursorTypes
     */
    public static ContractSearchFormWithoutCursorTypes fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ContractSearchFormWithoutCursorTypes.class);
    }

    /**
     * Convert an instance of ContractSearchFormWithoutCursorTypes to an JSON string
     *
     * @return JSON string
     */
