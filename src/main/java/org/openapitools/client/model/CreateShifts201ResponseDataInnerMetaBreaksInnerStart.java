...
public class CreateShifts201ResponseDataInnerMetaBreaksInnerStart {
  ...
  public CreateShifts201ResponseDataInnerMetaBreaksInnerStart date(String date) {
    this.date = date;
    return this;
  }
  ...
  public CreateShifts201ResponseDataInnerMetaBreaksInnerStart time(String time) {
    this.time = time;
    return this;
  }
