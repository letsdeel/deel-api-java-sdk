...
public class TimeTrackingShiftCreatedResponse {
  ...
  public boolean equals(Object o) {
    ...
    TimeTrackingShiftCreatedResponse timeTrackingShiftCreatedResponse = (TimeTrackingShiftCreatedResponse) o;
    return Objects.equals(this.externalId, timeTrackingShiftCreatedResponse.externalId) &&
        Objects.equals(this.description, timeTrackingShiftCreatedResponse.description) &&
        Objects.equals(this.dateOfWork, timeTrackingShiftCreatedResponse.dateOfWork) &&
        Objects.equals(this.contractId, timeTrackingShiftCreatedResponse.contractId) &&
        Objects.equals(this.meta, timeTrackingShiftCreatedResponse.meta) &&
        Objects.equals(this.summary, timeTrackingShiftCreatedResponse.summary) &&
        Objects.equals(this.createdAt, timeTrackingShiftCreatedResponse.createdAt) &&
        Objects.equals(this.updatedAt, timeTrackingShiftCreatedResponse.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(externalId, description, dateOfWork, contractId, meta, summary, createdAt, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimeTrackingShiftCreatedResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeTrackingShiftCreatedResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeTrackingShiftCreatedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeTrackingShiftCreatedResponse is not found in the empty JSON string", TimeTrackingShiftCreatedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeTrackingShiftCreatedResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeTrackingShiftCreatedResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimeTrackingShiftCreatedResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeTrackingShiftCreatedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeTrackingShiftCreatedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeTrackingShiftCreatedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeTrackingShiftCreatedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeTrackingShiftCreatedResponse>() {
           @Override
           public void write(JsonWriter out, TimeTrackingShiftCreatedResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeTrackingShiftCreatedResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeTrackingShiftCreatedResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeTrackingShiftCreatedResponse
   * @throws IOException if the JSON string is invalid with respect to TimeTrackingShiftCreatedResponse
   */
  public static TimeTrackingShiftCreatedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeTrackingShiftCreatedResponse.class);
  }

  /**
   * Convert an instance of TimeTrackingShiftCreatedResponse to an JSON string
   *
   * @return JSON string
   */
