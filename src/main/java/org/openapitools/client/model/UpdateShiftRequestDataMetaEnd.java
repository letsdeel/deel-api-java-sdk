...
public class UpdateShiftRequestDataMetaEnd {
  ...
  public UpdateShiftRequestDataMetaEnd date(String date) {
    this.date = date;
    return this;
  }
  ...
  public UpdateShiftRequestDataMetaEnd time(String time) {
    this.time = time;
    return this;
  }
  ...
  public UpdateShiftRequestDataMetaEnd isRestDay(Boolean isRestDay) {
  ...
  public UpdateShiftRequestDataMetaEnd isPublicHoliday(Boolean isPublicHoliday) {
