...
public class TimesheetSearchContainer {
   ...
   */
  @javax.annotation.Nullable
  public TimesheetSearchContainerTypes getTypes() {
    return types;
  }
   ...
   */
  @javax.annotation.Nullable
  public TimesheetSearchContainerStatuses getStatuses() {
    return statuses;
  }
  ...
  public boolean equals(Object o) {
    ...
    TimesheetSearchContainer timesheetSearchContainer = (TimesheetSearchContainer) o;
    return Objects.equals(this.limit, timesheetSearchContainer.limit) &&
        Objects.equals(this.offset, timesheetSearchContainer.offset) &&
        Objects.equals(this.orderDirection, timesheetSearchContainer.orderDirection) &&
        Objects.equals(this.contractId, timesheetSearchContainer.contractId) &&
        Objects.equals(this.invoiceId, timesheetSearchContainer.invoiceId) &&
        Objects.equals(this.reporterId, timesheetSearchContainer.reporterId) &&
        Objects.equals(this.contractTypes, timesheetSearchContainer.contractTypes) &&
        Objects.equals(this.types, timesheetSearchContainer.types) &&
        Objects.equals(this.statuses, timesheetSearchContainer.statuses) &&
        Objects.equals(this.dateFrom, timesheetSearchContainer.dateFrom) &&
        Objects.equals(this.dateTo, timesheetSearchContainer.dateTo);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetSearchContainer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimesheetSearchContainer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimesheetSearchContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetSearchContainer is not found in the empty JSON string", TimesheetSearchContainer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimesheetSearchContainer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimesheetSearchContainer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("types") != null && !jsonObj.get("types").isJsonNull()) {
        TimesheetSearchContainerTypes.validateJsonElement(jsonObj.get("types"));
      }
      // validate the optional field `statuses`
      if (jsonObj.get("statuses") != null && !jsonObj.get("statuses").isJsonNull()) {
        TimesheetSearchContainerStatuses.validateJsonElement(jsonObj.get("statuses"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetSearchContainer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetSearchContainer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetSearchContainer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetSearchContainer.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetSearchContainer>() {
           @Override
           public void write(JsonWriter out, TimesheetSearchContainer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimesheetSearchContainer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimesheetSearchContainer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimesheetSearchContainer
   * @throws IOException if the JSON string is invalid with respect to TimesheetSearchContainer
   */
  public static TimesheetSearchContainer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetSearchContainer.class);
  }

  /**
   * Convert an instance of TimesheetSearchContainer to an JSON string
   *
   * @return JSON string
   */
