...
public class UpdateOrgStructureRequestData {
  ...
  public UpdateOrgStructureRequestData name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateOrgStructureRequestData teams(List<Object> teams) {
    this.teams = teams;
    return this;
  }
  ...
  public UpdateOrgStructureRequestData externalId(String externalId) {
  ...
  public UpdateOrgStructureRequestData enableRoles(Boolean enableRoles) {
  ...
  public UpdateOrgStructureRequestData isMultiselect(Boolean isMultiselect) {
