...
public class GetTimesheetsByContract200ResponseDataInnerReviewedBy {
  ...
  public GetTimesheetsByContract200ResponseDataInnerReviewedBy id(CreateEorContractRequestClientTeamId id) {
    this.id = id;
    return this;
  }
  ...
  public GetTimesheetsByContract200ResponseDataInnerReviewedBy remarks(String remarks) {
  ...
  public GetTimesheetsByContract200ResponseDataInnerReviewedBy fullName(String fullName) {
  ...
  public GetTimesheetsByContract200ResponseDataInnerReviewedBy reviewedAt(String reviewedAt) {
