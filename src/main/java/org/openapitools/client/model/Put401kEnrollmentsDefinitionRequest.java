...
public class Put401kEnrollmentsDefinitionRequest {
  ...
  public boolean equals(Object o) {
    ...
    Put401kEnrollmentsDefinitionRequest put401kEnrollmentsDefinitionRequest = (Put401kEnrollmentsDefinitionRequest) o;
    return Objects.equals(this.type, put401kEnrollmentsDefinitionRequest.type) &&
        Objects.equals(this.details, put401kEnrollmentsDefinitionRequest.details) &&
        Objects.equals(this.contributionType, put401kEnrollmentsDefinitionRequest.contributionType) &&
        Objects.equals(this.contributionLimit, put401kEnrollmentsDefinitionRequest.contributionLimit) &&
        Objects.equals(this.contributionValue, put401kEnrollmentsDefinitionRequest.contributionValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class Put401kEnrollmentsDefinitionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Put401kEnrollmentsDefinitionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Put401kEnrollmentsDefinitionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Put401kEnrollmentsDefinitionRequest is not found in the empty JSON string", Put401kEnrollmentsDefinitionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Put401kEnrollmentsDefinitionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Put401kEnrollmentsDefinitionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Put401kEnrollmentsDefinitionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Put401kEnrollmentsDefinitionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Put401kEnrollmentsDefinitionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Put401kEnrollmentsDefinitionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Put401kEnrollmentsDefinitionRequest>() {
           @Override
           public void write(JsonWriter out, Put401kEnrollmentsDefinitionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Put401kEnrollmentsDefinitionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Put401kEnrollmentsDefinitionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Put401kEnrollmentsDefinitionRequest
   * @throws IOException if the JSON string is invalid with respect to Put401kEnrollmentsDefinitionRequest
   */
  public static Put401kEnrollmentsDefinitionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Put401kEnrollmentsDefinitionRequest.class);
  }

  /**
   * Convert an instance of Put401kEnrollmentsDefinitionRequest to an JSON string
   *
   * @return JSON string
   */
