...
public class RoleToUpdateContainerData {
  ...
  public RoleToUpdateContainerData name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RoleToUpdateContainerData description(String description) {
  ...
  public RoleToUpdateContainerData permissionSets(List<String> permissionSets) {
