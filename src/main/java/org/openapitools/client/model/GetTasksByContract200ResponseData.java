...
public class GetTasksByContract200ResponseData {
  ...
  public GetTasksByContract200ResponseData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetTasksByContract200ResponseData amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public GetTasksByContract200ResponseData status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public GetTasksByContract200ResponseData attachment(GetTasksByContract200ResponseDataAttachment attachment) {
  ...
  public void setAttachment(GetTasksByContract200ResponseDataAttachment attachment) {
    this.attachment = attachment;
  }


  public GetTasksByContract200ResponseData description(String description) {
  ...
  public GetTasksByContract200ResponseData dateSubmitted(LocalDate dateSubmitted) {
