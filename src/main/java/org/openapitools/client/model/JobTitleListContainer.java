...
public class JobTitleListContainer {
  ...
  public JobTitleListContainer data(List<JobTitle> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(List<JobTitle> data) {
    this.data = data;
  }


  public JobTitleListContainer page(GetJobTitleList200ResponsePage page) {
    this.page = page;
    return this;
  }
