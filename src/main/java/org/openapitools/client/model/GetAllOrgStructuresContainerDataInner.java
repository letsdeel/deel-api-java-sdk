...
public class GetAllOrgStructuresContainerDataInner {
  ...
  public GetAllOrgStructuresContainerDataInner id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public GetAllOrgStructuresContainerDataInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetAllOrgStructuresContainerDataInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public GetAllOrgStructuresContainerDataInner roles(List<GetAllOrgStructuresContainerDataInnerRolesInner> roles) {
    this.roles = roles;
    return this;
  }
  ...
  public void setRoles(List<GetAllOrgStructuresContainerDataInnerRolesInner> roles) {
    this.roles = roles;
  }


  public GetAllOrgStructuresContainerDataInner teams(List<Object> teams) {
    this.teams = teams;
    return this;
  }
  ...
  public GetAllOrgStructuresContainerDataInner externalId(String externalId) {
  ...
  public GetAllOrgStructuresContainerDataInner teamsCount(Integer teamsCount) {
  ...
  public GetAllOrgStructuresContainerDataInner enableRoles(Boolean enableRoles) {
  ...
  public GetAllOrgStructuresContainerDataInner isMultiselect(Boolean isMultiselect) {
