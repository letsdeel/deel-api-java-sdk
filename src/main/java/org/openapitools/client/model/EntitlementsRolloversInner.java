...
public class EntitlementsRolloversInner {
  ...
  public EntitlementsRolloversInner expirationDate(OffsetDateTime expirationDate) {
  ...
  public EntitlementsRolloversInner rolloverTrackingPeriod(OffsetDateTime rolloverTrackingPeriod) {
  ...
  public EntitlementsRolloversInner amount(GetProfileEntitlements200ResponseEntitlementsInnerRolloversInnerAmount amount) {
    this.amount = amount;
    return this;
  }
