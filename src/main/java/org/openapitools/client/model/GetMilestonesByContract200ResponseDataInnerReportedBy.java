...
public class GetMilestonesByContract200ResponseDataInnerReportedBy {
  ...
  public GetMilestonesByContract200ResponseDataInnerReportedBy id(GetMilestonesByContract200ResponseDataInnerReportedById id) {
    this.id = id;
    return this;
  }
  ...
  public void setId(GetMilestonesByContract200ResponseDataInnerReportedById id) {
    this.id = id;
  }


  public GetMilestonesByContract200ResponseDataInnerReportedBy fullName(String fullName) {
