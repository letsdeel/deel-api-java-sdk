...
public class CreateTaskManyReview201ResponseDataInner {
  ...
  public CreateTaskManyReview201ResponseDataInner id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CreateTaskManyReview201ResponseDataInner amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CreateTaskManyReview201ResponseDataInner status(String status) {
    this.status = status;
    return this;
  }
  ...
  public CreateTaskManyReview201ResponseDataInner attachment(CreateTaskManyReview201ResponseDataInnerAttachment attachment) {
  ...
  public CreateTaskManyReview201ResponseDataInner description(String description) {
  ...
  public CreateTaskManyReview201ResponseDataInner dateSubmitted(LocalDate dateSubmitted) {
