...
public class GetOffCyclePaymentsByContract200ResponseDataInnerReportedBy {
  ...
  public GetOffCyclePaymentsByContract200ResponseDataInnerReportedBy id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public GetOffCyclePaymentsByContract200ResponseDataInnerReportedBy fullName(String fullName) {
