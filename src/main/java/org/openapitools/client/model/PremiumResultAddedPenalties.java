...
public class PremiumResultAddedPenalties {
  ...
  public PremiumResultAddedPenalties name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PremiumResultAddedPenalties description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, premiumResultAddedPenalties.name) &&
        Objects.equals(this.description, premiumResultAddedPenalties.description);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PremiumResultAddedPenalties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PremiumResultAddedPenalties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PremiumResultAddedPenalties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PremiumResultAddedPenalties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
