...
public class GetDepartments200ResponseDataInner {
  ...
  public GetDepartments200ResponseDataInner id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  public GetDepartments200ResponseDataInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetDepartments200ResponseDataInner parent(String parent) {
    this.parent = parent;
    return this;
  }
