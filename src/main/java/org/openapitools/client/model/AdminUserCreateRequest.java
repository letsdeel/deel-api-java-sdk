...
public class AdminUserCreateRequest {
  ...
  public AdminUserCreateRequest firstName(String firstName) {
  ...
  public AdminUserCreateRequest lastName(String lastName) {
  ...
  public AdminUserCreateRequest email(String email) {
    this.email = email;
    return this;
  }
