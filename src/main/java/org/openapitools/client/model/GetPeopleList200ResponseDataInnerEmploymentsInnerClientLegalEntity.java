...
public class GetPeopleList200ResponseDataInnerEmploymentsInnerClientLegalEntity {
  ...
  public GetPeopleList200ResponseDataInnerEmploymentsInnerClientLegalEntity id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public GetPeopleList200ResponseDataInnerEmploymentsInnerClientLegalEntity name(String name) {
    this.name = name;
    return this;
  }
