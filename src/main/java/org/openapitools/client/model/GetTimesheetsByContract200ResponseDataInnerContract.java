...
public class GetTimesheetsByContract200ResponseDataInnerContract {
  ...
  public GetTimesheetsByContract200ResponseDataInnerContract id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetTimesheetsByContract200ResponseDataInnerContract type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public GetTimesheetsByContract200ResponseDataInnerContract title(String title) {
    this.title = title;
    return this;
  }
