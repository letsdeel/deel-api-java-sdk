...
public class ApiClient {
    ...
    private String basePath = "https://api.letsdeel.com/rest/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("deelToken", new HttpBearerAuth("bearer"));
        authentications.put("oauth2", new OAuth());
        authentications.put("public", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://auth.deel.com/tokens";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/alpha-0.0.13/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.letsdeel.com/rest/v2
